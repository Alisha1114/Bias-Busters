...
# Bold title and text
st.markdown('<h1 style="font-weight:bold;">Level 5:</h1>', unsafe_allow_html=True)
st.markdown('<p style="font-weight:bold; font-size:1.2rem;">Cognitive Bias</p>', unsafe_allow_html=True)
