...
background('images/neptune.jpeg')


st.markdown('<p style="text-align:center; padding:6px; background-color:black">You think a classmate is “bad at math” because of one bad test. What should you do?</p>',unsafe_allow_html=True)
...
if st.session_state.done_clicked:
    ...
    if st.button("Next"):
        ...
        st.session_state.clicked = None
        st.session_state.done_clicked = False
        st.switch_page("pages/level5_q2.py")
