...
background('images/venus.jpeg')


st.markdown('<p style="text-align:center; padding:6px; background-color:black">Your class is picking a team leader for a group project. Who should be the leader?</p>',unsafe_allow_html=True)
